  <nav class="bg-gray-800 dark:bg-gray-800/50">
      ...
      <div class="flex h-16 items-center justify-between">
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4 ">
              ...
              <x-nav-link href="/aboute" :current="request()->is('aboute')">Aboute</x-nav-link>
        ...
        <div class="hidden md:block">
          <div class="ml-4 flex items-center md:ml-6">
            <button type="button"
              class="relative rounded-full p-1 text-gray-400 hover:text-white focus:outline-2 
    ...
    <el-disclosure id="mobile-menu" hidden class="block md:hidden">
      <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
        ...
        <x-nav-link class="block" href="/aboute" :current="request()->is('aboute')">Aboute</x-nav-link>
      </div>
