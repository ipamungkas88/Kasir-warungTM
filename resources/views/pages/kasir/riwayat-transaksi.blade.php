<x-sidebar-layout>
  ...
  <div class="mx-auto max-w-7xl">
    <div class="py-6">
      ...
      <div class="mx-auto max-w-none">
        ...
        <p class="mt-2 text-gray-600 dark:text-gray-400">Lihat semua transaksi yang telah dilakukan
        </p>
      </div>
      ...
      <div class="mx-auto max-w-none mt-8">
        <div class="bg-white shadow rounded-lg p-6 dark:bg-gray-800 mb-6">
          ...
          <form method="GET" action="{{ route('kasir.riwayat-transaksi') }}"
            ...
            <div class="md:col-span-2 lg:col-span-1">
              ...
              <input type="text" name="search" id="search" value="{{ request('search') }}"
                class="block w-full px-4 py-3 text-base min-w-[200px] rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
            ...
            <div>
              ...
              <input type="date" name="date_from" id="date_from"
                ...
                class="block w-full px-4 py-3 text-base min-w-[160px] rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
            </div>
            ...
            <div class="flex items-end">
              <button type="submit"
                class="w-full min-w-[120px] bg-blue-600 hover:bg-blue-700 text-white py-3 px-4 rounded-md font-medium">
                Filter
              </button>
            </div>
          </form>
          ...
          <div class="mt-4 flex flex-wrap gap-2">
            <a href="{{ route('kasir.riwayat-transaksi', ['date_from' => today()->format('Y-m-d'), 'date_to' => today()->format('Y-m-d')]) }}"
            ...
            <a href="{{ route('kasir.riwayat-transaksi', ['date_from' => today()->subDays(6)->format('Y-m-d'), 'date_to' => today()->format('Y-m-d')]) }}"
              class="bg-gray-100 hover:bg-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 px-3 py-1 rounded text-sm">
              7 Hari Terakhir
            </a>
            <a href="{{ route('kasir.riwayat-transaksi', ['date_from' => today()->startOfMonth()->format('Y-m-d'), 'date_to' => today()->format('Y-m-d')]) }}"
              class="bg-gray-100 hover:bg-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 px-3 py-1 rounded text-sm">
              Bulan Ini
            </a>
            ...
            <div class="flex items-center">
              ...
              <div class="ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd class="text-lg font-semibold text-gray-900 dark:text-white">
                    Rp
                    {{ $transactions->count() > 0 ? number_format($totalRevenue / $transactions->count(), 0, ',', '.') : '0' }}
                  </dd>
                </dl>
              </div>
            </div>
  ...
  <script>
    function showTransactionDetail(transactionId) {
      ...
      fetch(`/kasir/transaksi/${transactionId}/detail`)
