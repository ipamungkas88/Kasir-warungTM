  ...
  <div class="mx-auto max-w-7xl">
    <div class="py-6">
      <div class="mx-auto max-w-none">
        ...
        <p class="mt-2 text-gray-600 dark:text-gray-400">Lihat laporan dan analisis penjualan</p>
      </div>
      <div class="mx-auto max-w-none mt-8">
        <div class="bg-white shadow rounded-lg p-6 dark:bg-gray-800">
          <p class="text-gray-500 dark:text-gray-400">Halaman laporan penjualan akan segera
            tersedia...</p>
        </div>
      </div>
    </div>
